---
name: "express-nodejs-web-security-spec (Part 1)"
description: Security spec for Express 5.x/4.19.2+ Node.js apps covering secure code generation and vulnerability auditing.
domain: backend
tags: [express, nodejs, security, web-security, audit]
triggers: express security, nodejs web security, express vulnerability audit
---
