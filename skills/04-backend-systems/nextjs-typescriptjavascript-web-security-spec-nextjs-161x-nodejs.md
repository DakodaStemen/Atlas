---
name: nextjs-web-security-spec
description: Security spec for Next.js 16.1.x apps covering secure code generation and vulnerability auditing.
domain: backend
tags: [nextjs, typescript, javascript, security, web-security, audit]
triggers: nextjs security, next.js web security, nextjs vulnerability audit
---
...
Use when the user asks about or needs: Next.js (TypeScript/JavaScript) Web Security Spec (Next.js 16.1.x, Node.js 20.9+).
