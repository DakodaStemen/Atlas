...
domain: testing
tags: [playwright, browser, electron, debugging, ui-testing, js-repl]
triggers: playwright interactive, browser debugging, electron testing, ui debugging
---
...
Use when the user asks about or needs: "playwright-interactive".
