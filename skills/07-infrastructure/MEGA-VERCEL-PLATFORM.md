...
description: Deploy applications and websites to Vercel with preview or production deployments.
domain: infrastructure
tags: [vercel, deployment, preview, production, hosting]
triggers: deploy to vercel, deploy my app, push this live, create preview deployment
---
...
2. **Retrieve the preview URL.** If the CLI is authenticated:
...
1. **If a git remote exists**, use repo-based linking with the selected team scope:
...
2. **Then deploy using the best available method:**
...
Use when the user asks about or needs: deploy-to-vercel.
﻿---
...
### Impact: MEDIUM (optional impact description) (Rule Title Here)
...
Use when the user asks about or needs: Rule Title Here.
﻿---
name: Sections
description: # Sections  This file defines all sections, their ordering, impact levels, and descriptions.
---
...
Use when the user asks about or needs: Sections.
﻿---
...
Use when the user asks about or needs: vercel-composition-patterns.
﻿---
name: vercel-deploy
...
Use when the user asks about or needs: vercel-deploy.
