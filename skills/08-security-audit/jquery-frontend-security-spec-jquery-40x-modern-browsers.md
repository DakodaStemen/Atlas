---
name: jquery-frontend-security-spec
description: Security spec for jQuery 4.0.x frontend apps covering secure code generation and vulnerability auditing.
domain: security
tags: [jquery, frontend, javascript, security, web-security, audit]
triggers: jquery security, jquery frontend security, jquery vulnerability audit
---
...
Use when the user asks about or needs: jQuery Frontend Security Spec (jQuery 4.0.x, modern browsers).
