...
description: Security best practices for Mapbox access tokens including scope management and rotation strategies.
domain: security
tags: [mapbox, tokens, api-security, access-control, rotation]
triggers: mapbox token security, mapbox access token, mapbox api key management
---
...
#### Characteristics (Secret Tokens (sk.\*))
...
#### Characteristics (Temporary Tokens (tk.\*))
...
#### When to use (Temporary Tokens (tk.\*))
