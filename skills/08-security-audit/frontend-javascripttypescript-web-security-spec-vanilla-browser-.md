---
name: frontend-js-ts-web-security-spec
description: Security spec for vanilla frontend JS/TS covering secure code generation and vulnerability auditing.
domain: security
tags: [javascript, typescript, frontend, browser, security, web-security, audit]
triggers: frontend security, vanilla js security, browser javascript security audit
---
...
Use when the user asks about or needs: Frontend JavaScript/TypeScript Web Security Spec (Vanilla Browser JS/TS, Modern Browsers).
