---
name: vuejs-web-security-spec
description: Security spec for Vue 3.x with Vite covering secure code generation and vulnerability auditing.
domain: security
tags: [vuejs, vue, typescript, javascript, vite, security, web-security, audit]
triggers: vue security, vuejs web security spec, vue vulnerability audit
---
...
Use when the user asks about or needs: Vue.js Web Security Spec (Vue 3.x, TypeScript/JavaScript, common tooling: Vite).
