...
description: Repository-grounded threat modeling with trust boundaries, assets, abuse paths, and mitigations.
domain: security
tags: [security, threat-model, appsec, trust-boundaries, abuse-paths]
triggers: threat model, enumerate threats, appsec threat modeling, abuse paths
---
...
Use when the user asks about or needs: "security-threat-model".
