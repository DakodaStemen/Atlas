---
name: react-web-security-spec
description: Security spec for React 19.x with TypeScript covering secure code generation and vulnerability auditing.
domain: security
tags: [react, typescript, javascript, security, web-security, audit]
triggers: react security, react web security spec, react vulnerability audit
---
...
Use when the user asks about or needs: React (JavaScript/TypeScript) Web Security Spec (React 19.x, TypeScript 5.x).
