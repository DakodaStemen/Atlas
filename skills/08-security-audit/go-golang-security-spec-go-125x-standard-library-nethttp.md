---
name: go-golang-security-spec
description: Security spec for Go 1.25.x apps with net/http covering secure code generation and vulnerability auditing.
domain: security
tags: [go, golang, security, net-http, web-security, audit]
triggers: go security, golang security spec, go vulnerability audit
---
...
Use when the user asks about or needs: Go (Golang) Security Spec (Go 1.25.x, Standard Library, net/http).
